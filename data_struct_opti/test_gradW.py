import numpy as np
import pytest
from data_struct_opti.grad_w_optimized import gradW, gradW_inplace, gradW_float32
from data_struct_opti.sph_optimized import getPairwiseSeparations_inplace
